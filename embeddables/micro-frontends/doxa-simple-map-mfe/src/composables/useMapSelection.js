...
// 
// QA Reference: Round 1 Q4 - Composable decomposition (lines 241-245)
// Design Flaw Fix: Extracts selection logic from MapComponent (~150 lines)
//
 ...
 * - updateRegionVisibility() (lines 1174-1193)
 * - updatePinOpacityByRegion() (lines 1197-1220)
 * - updateLanguageFamilyVisibility() (lines 1301-1330)
 * 
...
export function useMapSelection(options = {}) {
     ...
     * 
     * @param {string} scheme - Color scheme ('doxa-regions', 'affinity-blocs', 'none')
     */
