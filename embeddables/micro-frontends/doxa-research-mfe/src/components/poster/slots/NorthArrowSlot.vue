<script setup>
/**
 * NorthArrowSlot.vue — STUB. Poster-rendering slot for NorthArrowSlot.
...
<template>
  <div class="poster-slot poster-slot--NorthArrowSlot" data-slot="NorthArrowSlot">
    <!-- NorthArrowSlot stub — implement when poster export is wired -->
  </div>
</template>

<style scoped>
.poster-slot { display:none; }
</style>
