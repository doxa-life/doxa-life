...
import { useMapPoster } from './poster/useMapPoster.js';

/**
 * @param {() => any} getMap  function returning the live Mapbox map
 * @returns {{
 *   renderPacket: (spec: import('./poster/useMapPoster.js').PosterSpec, peopleGroups: Array<Object>, meta?: Object) => Promise<Blob>,
...
export function useMapPacket(getMap) {
   ...
   * @param {import('./poster/useMapPoster.js').PosterSpec} spec  same shape useMapPoster uses
