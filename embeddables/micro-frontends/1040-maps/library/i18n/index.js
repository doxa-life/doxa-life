 ...
 * area. Every locale ships the 8 core areas (aria, buttons, detail, legend,
 * messages, options, prayerLaps, search). Two areas are partially translated:
 * tabs.json exists for ar/de/en/es/fr/pt/ru (hi/it/ro/zh fall back to English
 * for tabs.*), and popup.json exists only for en/fr. A missing area file is
 * fine — those namespaces resolve through fallbackLocale: 'en'.
