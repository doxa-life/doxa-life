...
|---|---|---|
| `legends/` | Legend UI — `LegendDesktop.vue`, `LegendMobile.vue`, `LegendRows.vue`, `LegendTools.vue`, `SemanticTreeLegend.vue` | [`/docs/components/legend-components.md`](../../../docs/components/legend-components.md) |
