...
// the doxa-maps build now publishes /embed/doxa-maps-build/doxa-maps/doxa-research-map/doxa-research-map.js (canonical name).
...
<template>
  <div class="container page-content uupgs-page stack stack--3xl">
    ...
    <!-- Research map embed — sits directly under the H1, above the UUPG
         search bar. Loads /embed/doxa-maps-build/doxa-maps/doxa-research-map/doxa-research-map.js (auto-published from
