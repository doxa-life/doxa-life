...
export const zh: TermsContent = {
  ...
  entries: [
    ...
    },
    {
      ...
      rationale:
        '和合本马太福音 3:3 作“预备主的道”，以赛亚书 40:3 作“在旷野预备耶和华的路”。词条把两者合成“道路”，与和合本的任何一处都不字字相同；这样取舍是为了让短语独立成句时读得顺，圣经的回声中文读者仍一听就能听出。'
    },
    {
      term: '心灵语言',
    ...
    },
    {
      ...
      definition: '整件事的定位：到2033年接触每一个族群，作为教会共同献上的敬拜——是献祭式的，不是交易式的。',
    ...
    },
    {
      ...
      definition:
        '招募、培训、支持并差派宣教士的机构。DOXA 与差派机构合作（截至2026年有 129 个隶属 WAGF 的机构），但不取代它们。',
    ...
    },
    {
      ...
      rationale:
        '和合本启示录 5:9 作“从各族、各方、各民、各国中买了人来”，这是应用为中文取用经文的版本。和合本在启示录 7:9 里四个名词的次序不同，作“从各国、各族、各民、各方来的”；本版一律采用 5:9 的次序，使全站只有一个固定说法，这一点与和合本的 7:9 并不一致，留待审核者定夺。此前草稿里的“各支派、各方言、各民族、各邦国”不属于任何一个中文译本。'
    }
  ]
}
