...
export const pt: TermsContent = {
  ...
  entries: [
    ...
    },
    {
      ...
      definition:
        'um grupo étnico sem crentes conhecidos ou com muito poucos, e sem os quatro níveis primários de engajamento efetivo (esforço apostólico residente; trabalho na cultura local e na língua do coração; compromisso ministerial de longo prazo; semeadura do evangelho visando um movimento de plantação de igrejas). Um termo técnico da IMB: diz que ninguém trabalha entre eles, não que as pessoas sejam indiferentes.',
    ...
    },
    {
      ...
      definition:
        'atividade sustentada, residente e transcultural para partilhar Cristo e fazer discípulos, com esforços para estabelecer igrejas autossustentáveis, de formas culturalmente apropriadas e localmente relevantes (ver „O que é engajamento?“ na página Visão).',
    ...
    },
    {
      ...
      rationale:
        'Mateus 9:38 nas traduções de Almeida: „Rogai, pois, ao Senhor da seara que mande ceifeiros para a sua seara“ (Revista e Corrigida; a Revista e Atualizada diz „trabalhadores“) — a citação que a página Ore já traz. A NVI diz „Senhor da colheita“; seguimos Almeida, corrente nas Assembleias de Deus. A metáfora agrícola (seara = pessoas prontas a responder) fica preservada.'
    },
    {
    ...
    },
    {
      ...
      alternatives: 'Comunhão das Assembléias de Deus Mundial · Fraternidade Mundial das Assembleias de Deus',
      rationale:
        'nomes de organizações não se traduzem pela regra do glossário, mas o site usa a forma que o revisor escolheu, „Comunhão das Assembléias de Deus Mundial“, seguida do nome em inglês e da sigla WAGF, que se mantém igual em todo o site.'
    },
    {
