...
// public/js/doxa-maps-build/ (the doxa-maps bundler's output folder, dropped in here),
// served at /js/doxa-maps-build/doxa-maps/<bundle>/<bundle>.js. Each IIFE bundle
// registers its own custom element (doxa-map / doxa-research-map), so only one
// bundle should load per page.
const BUNDLES = {
  'simple-map':   '/js/doxa-maps-build/doxa-maps/doxa-simple-map/doxa-simple-map.js',
  'research-map': '/js/doxa-maps-build/doxa-maps/doxa-research-map/doxa-research-map.js'
} as const
