...
builds live under `public/embed/doxa-maps-build/`, and the app serves the Mapbox
...
See `public/embed/doxa-maps-build/doxa-maps/demo-map/demo-map/maplibre/index.html`.
...
`public/embed/doxa-maps-build/doxa-maps/doxa-simple-map/doxa-simple-map/engagement/index.html`).
